...
продукта, а то и функционального объекта, а то и самой функции (скажем,
...
к неустроенностям/frustrations.
...
Ещё один тренд --- это цифровая нить, связывающая системы проектирования
